    ...
    <div class="container">
        ...
        <?php if ($onglet === 'streamers') : ?>
            <h2 class="mb-4">
                ...
                <span style="font-size: 1rem; color: var(--text-secondary);">(<?= count($streamers) ?> streamer<?= count($streamers) > 1 ? 's' : '' ?>)</span>
            </h2>

            <?php if (empty($streamers)) : ?>
                <p style="color: var(--text-secondary);">Aucun streamer enregistré.</p>
                ...
                <div class="table-responsive">
                    <table class="table" style="color: var(--text-primary);">
                        <thead style="border-bottom: 2px solid var(--accent);">
                            <tr>
                                <th style="color: var(--accent);">Nom</th>
                                <th style="color: var(--accent);">Chaîne</th>
                                <th style="color: var(--accent);">Email</th>
                                <th style="color: var(--accent);">Matricule</th>
                                <th style="color: var(--accent);">Lives</th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <?php elseif ($onglet === 'materiels') : ?>
            ...
            <?php if (empty($materiels)) : ?>
                <p style="color: var(--text-secondary);">Aucun matériel enregistré.</p>
            <?php else : ?>
                <div class="row g-4">
                    ...
                    <div class="card p-4">
                        <form method="POST" action="index.php?page=espace_admin&onglet=creer_streamer">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label class="form-label" style="color: var(--text-secondary);">Nom *</label>
                                    <input type="text" name="nom" class="form-control" style="background-color: var(--bg-secondary); border: 1px solid var(--accent); color: var(--text-primary);" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" style="color: var(--text-secondary);">Prénom *</label>
                                    <input type="text" name="prenom" class="form-control" style="background-color: var(--bg-secondary); border: 1px solid var(--accent); color: var(--text-primary);" required>
                                </div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label" style="color: var(--text-secondary);">Email *</label>
                                <input type="email" name="email" class="form-control" style="background-color: var(--bg-secondary); border: 1px solid var(--accent); color: var(--text-primary);" required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label" style="color: var(--text-secondary);">Mot de passe *</label>
                                <input type="password" name="password" class="form-control" style="background-color: var(--bg-secondary); border: 1px solid var(--accent); color: var(--text-primary);" required>
                            </div>

                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    <label class="form-label" style="color: var(--text-secondary);">Nom de chaîne *</label>
                                    <input type="text" name="nom_chaine" class="form-control" style="background-color: var(--bg-secondary); border: 1px solid var(--accent); color: var(--text-primary);" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" style="color: var(--text-secondary);">Âge</label>
                                    <input type="number" name="age" class="form-control" style="background-color: var(--bg-secondary); border: 1px solid var(--accent); color: var(--text-primary);" min="18" max="99">
                                </div>
                            </div>

                            <div class="mb-4">
                                <label class="form-label" style="color: var(--text-secondary);">Matricule</label>
                                <input type="text" name="matricule" class="form-control" style="background-color: var(--bg-secondary); border: 1px solid var(--accent); color: var(--text-primary);" placeholder="STR001">
                            </div>
