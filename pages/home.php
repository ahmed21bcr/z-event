...
<section class="hero text-center py-5">
    <div class="container">
        <h1 class="display-4 fw-bold">Bienvenue sur <span class="text-accent">Z-EVENT</span></h1>
        <p class="lead text-muted-zevent">
...
<section class="py-5">
    <div class="container">
        ...
        <?php if (empty($lives)) : ?>
            <p class="text-muted-zevent">Aucun live prévu pour le moment.</p>
        <?php else : ?>
            <div class="row g-4">
...
<!-- SECTION ASSOCIATION -->
<section class="py-5 section-secondary">
    <div class="container text-center">
        <h2 class="mb-3">Notre mission</h2>
        <p class="text-muted-zevent mx-auto" style="max-width: 600px;">
